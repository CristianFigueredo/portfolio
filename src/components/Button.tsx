...
export function Button({ label, className }: ButtonProps) {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-white px-5 py-1.5 text-sm font-light text-black backdrop-blur-3xl">
        {label}
      </span>
    </button>
  );
